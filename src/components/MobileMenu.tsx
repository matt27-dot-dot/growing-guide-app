...
import { Home, CheckSquare, User, Calendar, BookOpen, Baby, LogOut, Plus, BookOpen as DiaryIcon, Menu, X } from "lucide-react";
...
export const MobileMenu = () => {
  ...
  return (
    <Sheet open={isOpen} onOpenChange={setIsOpen}>
      ...
      <SheetContent side="right" className="w-64 bg-gradient-to-b from-purple-600 to-pink-600 text-white p-0">
